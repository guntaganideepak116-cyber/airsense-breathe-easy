...
export const dict = {
  ...
  "nav.mob.more": { te: "మరిన్ని", en: "More" },
  "nav.mob.menu": { te: "నేవిగేషన్ మెనూ", en: "Navigation Menu" },
  "nav.logout": { te: "సైన్ అవుట్", en: "Sign out" },
  "nav.logoutDesc": { te: "మీ ఖాతా నుండి నిష్క్రమించండి", en: "Sign out of your AirSense account" },
